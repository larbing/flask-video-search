...
# 定义变量
DOCKER_CONTAINER_NAME="flask-video-search"
DOCKER_IMAGE_NAME="abc7223/flask-video-search"
...
run_new_container() {
    ...
    docker run -d -v /data:/data -p 80:80 --name $DOCKER_CONTAINER_NAME $DOCKER_IMAGE_NAME:$DOCKER_TAG
}
